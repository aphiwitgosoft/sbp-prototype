...
- **Job 5 / Job 11 รับข้อมูลจาก EAI/RabbitMQ เองใน `SBP/srm-sps-spsap-sop-sgi-batch`** (มติ 2026-09-12 — ตัด repo `store-consumer` ออกจากขอบเขต) — job bind คิว · คุม ack/nack · DLQ · retry เอง · ⚠️ repo ปลายทางมีแต่ `publishMessage` ยังไม่มี consumer ต้องสร้างใหม่
