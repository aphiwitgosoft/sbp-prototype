...
- `database.md` — the 20-table target schema, mirrors `plan-database.html` (data spine, zones A/B/C, cross-system keys, P0/P1 fixes).
...
- **`workflow.md` / `api.md` / `database.md`** — living docs (flow · 29 endpoint 6 กลุ่ม · 20 ตาราง) คู่กับ `plan-flow.html` / `plan-api.html` / `plan-database.html`
- **`LLDD/md/`** — เอกสารส่งมอบ 40 ฉบับ (สเปกระดับลงมือทำ พร้อม SQL/skeleton/flow ต่อหัวข้อ)
