...
- `api.md` — the 62-endpoint / 10-group REST spec, mirrors `plan-api.html` (per-endpoint modal structure, business rules bound to endpoints, the commented abnormal-stores group).
