...
| --- | --- | --- |
| Load exact profile | เรียก GET /api/v1/sbpgi/document/{docNo} และยืนยัน roleProfileCode=P-01, statusCode=01 ก่อน render action state | profile mismatch ต้อง fail closed; ไม่ใช้ role switcher เพื่อจำลอง P-01 |
...
| Path ไฟล์ | หน้าที่ |
| --- | --- |
| src/app/(main)/sbpgi/document/[docNo]/page.tsx | route page — ใช้ร่วมกับหน้า detail — view ของ workflow section 01 |
| src/components/sbpgi/document-detail/RoleView01.tsx | component — view เฉพาะ workflow section 01 (อ่าน visibleSections/editableSections จาก API) |
| src/components/sbpgi/document-detail/ActionForm01.tsx | component — ฟอร์มผลการพิจารณา (result + comment) ของ section นี้ |
...
/** GET /api/v1/sbpgi/document/{docNo} — โหลด role profile P-01 สำหรับหน้า detail */
...
/** POST /api/v1/sbpgi/document/{docNo}/actions — ตัวอย่าง positive-path จาก section 01; Section 02 ส่งต่อ AVP (03) เมื่อยอดรวม ≥ 100,000 บาท และจบที่ GM เมื่อ < 100,000 บาท (มติ 2026-08-18) */
...
#### 8.6 ฟอร์มพิจารณา + validation — `src/components/sbpgi/document-detail/ActionForm01.tsx`
