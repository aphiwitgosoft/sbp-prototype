...
| Path ไฟล์ | หน้าที่ |
| --- | --- |
| src/app/(main)/sbpgi/documents/[docNo]/page.tsx | route page — ใช้ร่วมกับหน้า detail — view ของ workflow section 01 |
...
/** GET /api/v1/documents/{docNo} — โหลด role profile P-01 สำหรับหน้า detail */
...
/** POST /api/v1/documents/{docNo}/actions — ตัวอย่าง positive-path จาก section 01; Section 02 ส่งต่อ AVP (03) เมื่อยอดรวม ≥ 100,000 บาท และจบที่ GM เมื่อ < 100,000 บาท (มติ 2026-08-18) */
