...
| encoding ของไฟล์ | ประกาศเป็น WINDOWS-874 แต่ไฟล์จริง **เป็น ASCII ล้วน ไม่มีไบต์ภาษาไทยเลย** · วันที่ในไฟล์เป็น **ค.ศ.** (`20260824`) **ไม่ใช่ พ.ศ.** | 🔴 แก้ 2026-09-16 จากไฟล์ตัวอย่างจริง `docs/file_IAS_STA/` — เอกสารเดิมเขียนว่าเป็น พ.ศ. ซึ่งผิด · ที่เป็น พ.ศ. + windows-874 จริงคือ `FRBC0001` ของ STA (Job 6) เท่านั้น · รายละเอียด `docs/IAS-STA-interface-files.md` |
