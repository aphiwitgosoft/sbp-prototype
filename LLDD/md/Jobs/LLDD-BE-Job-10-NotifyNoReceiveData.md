...
| Transaction proof | อ่าน pending แบบ read-only (ไม่แตะ outbox_status — Job 6 เป็นผู้เขียนเมื่อได้ publisher confirm); reserve notification marker ก่อนส่ง; ส่งล้มเหลว mark FAILED และ retry ด้วย marker เดิม | injected failure leaves no partial committed state outside documented boundary |
...
| Transaction boundary | อ่าน pending แบบ read-only (ไม่แตะ outbox_status — Job 6 เป็นผู้เขียนเมื่อได้ publisher confirm); reserve notification marker ก่อนส่ง; ส่งล้มเหลว mark FAILED และ retry ด้วย marker เดิม |
