...
> **อัปเดตขอบเขต 2026-08-06:** ยกเลิกหน้า **Overview Dashboard** (หน้าแรกเป็น "เอกสาร → รอดำเนินการ") · ยกเลิกและลบหน้า **ข้อมูลผิดปกติ / แจกงาน** · หน้า **สร้างเอกสาร** ไม่มีฟอร์ม (ต้นทางทำที่ระบบ FS) · วงเงินอนุมัติใหม่ **GM 50,000 / AVP 300,000** และเปลี่ยนคำเรียก **"ฝ่ายส่งเสริม" → "หน่วยงานส่งเสริมธุรกิจ"** ทุกจุด (SDD GI 24/02/2026) · **ชั่วโมง/แผนงานในตารางด้านล่างยังไม่ปรับ — ต้องทบทวนกับ PM (โดยเฉพาะ FE-Overview 39h และ FE-Create-Document)**
...
| LLDD-Database | BE/DB | 34-table target schema, data zones/spine, DDL reference, indexes, transaction rules, seed data | [PDF](../pdf/LLDD-Database.pdf) | [DOCX](../word/LLDD-Database.docx) |
