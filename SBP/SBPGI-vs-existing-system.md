...
> ## 📌 สถานะการตัดสินใจ (อัปเดต 2026-08-10)
>
> **ตัดสินแล้ว 3 ข้อ — แก้เอกสารออกแบบเรียบร้อยแล้ว**
>
> | DP | มติ | ผลที่แก้ไปแล้ว |
> |---|---|---|
> | **DP-1** | **ทางเลือก B — surrogate id** | `compensation_documents` ใช้ PK `id` · `doc_no` เป็น UNIQUE business key · `reference_id` ที่ส่งให้ engine = `id` |
> | **DP-3** | **ทางเลือกที่ 3 (ผสม)** | `impacted_stores` เป็น **snapshot บางส่วน** เก็บเฉพาะร้านที่เคยเข้ารอบชดเชย เติมตอนสร้าง `fgi_impact_processes` |
> | **DP-9** | **แยกตัดสิน** | `decisions` → `common_code` (`SBPGI_DECISION`) · `external_factors`+`competitors` ยังเป็นตารางของ SBPGI · **20 ตาราง · 29 เส้น** |
>
> **ยังค้าง 9 ข้อ:** DP-2 · DP-4 · DP-5 · DP-6 · DP-7 · DP-8 · DP-10 · DP-11 · DP-12
> (ตัวเลข "21 ตาราง / 30 เส้น" ที่ปรากฏด้านล่างคือสถานะ **ก่อน**มติ 2026-08-10 — คงไว้เพื่อให้เห็นที่มาของการวิเคราะห์)
...
## 4. ข้อที่ต้องตัดสินใจ (Decision Points) — 12 ข้อ · **ตัดสินแล้ว 3 (DP-1 · DP-3 · DP-9) เหลือค้าง 9**

> ทุกข้อในหัวข้อนี้มีทางเลือกจริง 2 ทาง · ข้อเสนอแนะเป็นความเห็นเชิงเทคนิค **การตัดสินใจขั้นสุดท้ายเป็นของเจ้าของโครงการ**

---

### DP-1 · `reference_id` ของ workflow = `doc_no` หรือ surrogate id? ✅ **ตัดสินแล้ว 2026-08-10 = ทางเลือก B (surrogate id)**
...
### DP-3 · `impacted_stores` เป็น view จากระบบเดิม หรือตาราง snapshot ของ SBPGI? ✅ **ตัดสินแล้ว 2026-08-10 = ทางเลือกที่ 3 (ผสม)**
...
### DP-9 · master 3 ตัว — ยัดลง `common_code` หรือตารางเล็กของ SBPGI? ✅ **ตัดสินแล้ว 2026-08-10 = แยกตัดสิน**
