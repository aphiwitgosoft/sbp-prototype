...
- [ ] `ReportSearchForm.tsx` (ลำดับตามผังจริง 2026-08-06): รหัสร้านกระทบ (+`StorePickerModal`) | ชื่อร้าน (readonly) · รหัสร้านเปิดใหม่ | **ประเภทร้าน (checkbox `A/B/C/E`)** · **เดือน/ปีที่ถูกกระทบ From–To (`MonthRangeInput` เต็มแถว)** · สถานะ\* (select 6 ค่า) | **radio ผลการพิจารณา\*: `ประกันรายได้` / `ไม่ประกันรายได้`** · ภาค (`REPORT_REGIONS13` — checkbox 13 รหัส เต็มแถว) · Period Statement From–To (เต็มแถว · บังคับเมื่อสถานะ = เสร็จสิ้นดำเนินการ) · ปุ่ม `เคลียร์ค่าเริ่มใหม่` / **`Preview Report`** / `Export`
