...
> ⚠️ **ข้อค้าง (ยังไม่ตัดสิน) — ตัวเลขชั่วโมงในไฟล์นี้ขัดกับแผน LLDD:** ไฟล์นี้ใช้ baseline **FE 510 + BE 595 + Shared 102 = 1,207 ชั่วโมง** ที่ **1 วัน = 8.5 ชั่วโมง** · ขณะที่ชุดเอกสาร LLDD ([`LLDD/md/README.md`](LLDD/md/README.md) + [`LLDD/md/LLDD-Main-Index-Phase4-4-3-SBP-Operating-Management.md`](LLDD/md/LLDD-Main-Index-Phase4-4-3-SBP-Operating-Management.md)) คำนวณสดจาก `HIGH_LEVEL_ESTIMATES` + `JOB_ESTIMATES` ได้ **682 ชั่วโมง · 6 คน · 1 วัน = 6 ชั่วโมง · 10/08/2026 - 08/09/2026** — ต่างกันเกือบ 2 เท่าและใช้สมมติฐานชั่วโมง/วันคนละค่า
>
> **ยังไม่ตัดสิน** ว่า (ก) 1,207 เป็น baseline เก่าที่ถูกแทนด้วยแผน LLDD 682 แล้ว หรือ (ข) สองชุดนี้เป็นคนละขอบเขต (estimate เต็มโปรเจกต์ vs ชั่วโมงเขียนเอกสาร LLDD) — **เจ้าของโครงการต้องเลือก** แล้วจึงปรับข้อความในทั้งสองฝั่งให้ตรงกัน · จนกว่าจะตัดสิน อย่าใช้ตัวเลขจากไฟล์นี้และจากชุด LLDD ปนกันในเอกสารเดียว
