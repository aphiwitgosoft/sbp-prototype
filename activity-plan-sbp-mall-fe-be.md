...
> | ชุด LLDD (implementation 671 + unit test 153) | **824** | 6.0 | **137.3** |
> | | | | ต่างกัน 1.2 md · **0.8%** |
>
> **มติ: ใช้ชุด LLDD `824 ชั่วโมง` @ **8 ชม./วัน (40 ชม./สัปดาห์)** — กรอบใหม่ 2026-08-25 “จบใน 4 สัปดาห์” (823 → 845 หลังรับ F8+F1 และงานจุดเข้า flow 2026-08-21 → **824** หลังตัด Job 1 ImportQSSI 2026-08-24) เป็นตัวเลขอ้างอิงเดียวของโครงการ** เพราะ (1) แตกละเอียดถึงระดับเอกสารรายฉบับ (2) รวม unit test แล้ว (3) `worklist.html` และหน้าแผนงานรายสัปดาห์ใช้ 30 ชม./สัปดาห์อยู่แล้ว
>
