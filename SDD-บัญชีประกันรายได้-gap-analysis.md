...
| 1.3 | หยุดชดเชยแล้ว **สร้างเอกสารใหม่ได้เดือนเดียวกัน/ถัดไป** (เลิกเปิด SR) | ✅ | `POST /documents` คืน 409 **เฉพาะเอกสาร active** · SQL ใช้ `status_code <> :statusDone` · partial unique index ใน `plan-be.md` §5 |
