...
export const FLOWCHARTS: Record<string, FcSpec> = {
  'POST /api/v1/documents/{docNo}/actions': {
    ...
    nodes: [
      ...
      { id: 'endE', type: 'termOk', x: 560, y: 404, w: 240, text: 'เสร็จสิ้นดำเนินการ (99)' },
      { id: 'p2', type: 'proc', x: 240, y: 514, w: 400, h: 66, text: '> 100,000 → AVP OPT (03) แล้วจบ\n≤ 100,000 → จบที่ GM OPT (02)\nอื่น ๆ → ขั้นถัดไปตามลำดับ' },
  ...
  'POST /api/v1/workflows/instances': {
    ...
    nodes: [
      ...
      { id: 'p1', type: 'proc', x: 250, y: 474, w: 400, h: 66, text: 'ใช้ compensation_documents ที่ Job 8 สร้างแล้ว\n+ workflow_instances + workflow_tasks (06)' },
