...
6. **เปิด Workflow ตาม Gen Flow Gate** (FGI/FCS Job 8b → K2 · **เปลี่ยนกลไก**) — เกณฑ์คงเดิมทุกข้อ: workflow_generation_status=W · branch type FAM/FB1/FC1/FB2/FVB/FVC · DV ไม่ว่าง · juristic ต่างกัน · growth_rate_diff ≤ −10 · sales_status ∈ {Y,N} — เดิมยิง K2 REST StartInstance / ใหม่เรียก `POST /workflows/instances` ภายในด้วย service token; ผ่าน gate ตั้ง workflow_generation_status=Y, branch type นอกเซ็ตตั้ง N, ข้อมูลยังไม่พร้อมคง W เพื่อ rerun
