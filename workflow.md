...
8. **ขั้น 3: หน่วยงานส่งเสริมธุรกิจฯ ปรับข้อมูล** (K2 · Section 01 · SDD GI ขยายผู้ปฏิบัติจากระดับฝ่ายเป็นเจ้าหน้าที่อาวุโสขึ้นไป ยกเว้น GM — ทำหน้าที่กลั่นกรองก่อนส่ง GM) — แก้ไขร้านเปิดใหม่ / ร้านคู่แข่ง (เลือกจาก master `GET /competitors`) / ปัจจัยภายนอก (`GET /factors`) (**%ชดเชยรวมต้อง = 100%**) บันทึกด้วย `PUT /documents/{docNo}` แล้วส่งพิจารณาต่อ หรือส่งกลับ (back-flow) · เห็นควรไม่ชดเชยที่ขั้นนี้ = จบกระบวนการทันที (SDD GI)
...
| | ส่งหน่วยงานส่งเสริมธุรกิจ SBP (SDD GI: เปลี่ยนชื่อปุ่มจาก "ส่งฝ่ายส่งเสริมธุรกิจ SBP") | รอ 01 |
...
>
> **การเปลี่ยนแปลงจาก SDD GI (24/02/2026) ที่ผูกกับตารางนี้:** (1) วงเงินเปลี่ยนจากเกณฑ์เดียว 100,000 → GM 50,000 / AVP 300,000 ต่อรายการ (2) ปุ่ม/ค่า enum "ส่งฝ่ายส่งเสริมธุรกิจ SBP" เปลี่ยนชื่อเป็น **"ส่งหน่วยงานส่งเสริมธุรกิจ SBP"** (ชื่อสถานะเอกสาร 6 ค่าคงเดิม — SDD ยังแสดง "รอฝ่ายส่งเสริมธุรกิจ SBP ดำเนินการ") (3) เห็นควรไม่ชดเชยที่ขั้น 01/02 จบกระบวนการทันที ไม่ตีกลับให้รับทราบเป็นทอด ๆ
