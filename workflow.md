...
- **ข้อมูลผิดปกติไม่ได้หายไปจากระบบ** — ยังเป็น **คุณสมบัติของข้อมูล** ตามเดิม: ร้านที่มียอดขาย < 60 วันแสดงเป็น **แถวแดง** (`tr.flag-red`) ในหน้า **รอดำเนินการ / ที่เกี่ยวข้อง** — เปลี่ยนจาก "หน้าจอแยก + แจกงาน" เป็น "ธงในหน้างานปกติ" · **ถอด stat cards ออกทั้ง 2 หน้าเมื่อ 2026-08-06** ทำให้ไม่มีการ์ดกรอง "ยอดขายไม่ครบ 60 วัน" อีก (⚠️ ถ้าต้องการกรองเฉพาะแถวแดง ต้องเพิ่มเป็นตัวเลือกในฟอร์มตัวกรอง — รอตัดสินใจ)
